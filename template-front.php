...
?>
    ...
    <header class="masthead">
        <div class="container">
            <div class="masthead-subheading">Découvrez nos espaces de travail</div>
            <h1 class="masthead-heading text-uppercase">Template</h1>
    ...
    <main class="container">
        ...
        <div class="p-5 rounded mt-5">
            <!-- <h2 class="pb-4 border-bottom">Template</h2> -->
